    ...
    <div class="posts">
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            <div class="post">
                ...
                <div class="post_img"><img src="<?php bloginfo('template_url') ?>/images/bpost1.png" alt="#"></div>
        ...
        <div class="pagination">
            <?php previous_post_link('<strong>%link</strong>'); next_post_link('<strong>%link</strong>') ?>
        </div>
